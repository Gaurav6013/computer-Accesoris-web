                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6">
                        <div className="text_img">
                          <figure>
                            <img src="../assests/images/pct.png" alt="#" />
                          </figure>
                        </div>
                      </div>
                    </div>
            ...
            <div className="row">
              <div className="col-md-4">
                <div className="box_text">
                  <i>
                    <img src="../assests/images/thr.png" alt="#" />
                  </i>
                  <h3>Computer</h3>
                  <p>
                    There are many variations of passages of Lorem Ipsum
              ...
              <div className="col-md-4">
                <div className="box_text">
                  <i>
                    <img src="../assests/images/thr1.png" alt="#" />
                  </i>
                  <h3>Laptop</h3>
                  <p>
                    There are many variations of passages of Lorem Ipsum
              ...
              <div className="col-md-4">
                <div className="box_text">
                  <i>
                    <img src="../assests/images/thr2.png" alt="#" />
                  </i>
                  <h3>Tablet</h3>
                  <p>
                    There are many variations of passages of Lorem Ipsum
                        ...
                        <div className="row">
                          <div className="col-md-9 offset-md-3">
                            <div className="test_box">
                              <i>
                                <img src="../assests/images/cos.png" alt="#" />
                              </i>
                              <h4>Sandy Miller</h4>
                              <p>
